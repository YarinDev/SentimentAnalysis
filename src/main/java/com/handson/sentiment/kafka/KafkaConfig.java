...
public class KafkaConfig {
    ...
    // This method configures and creates a KafkaSender instance for sending messages to Kafka topics.
    @Bean("simpleProducer")
    ...
    // This function initializes a KafkaReceiver for reading messages from Kafka topics with specified properties
    @Bean
